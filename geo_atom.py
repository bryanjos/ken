...
class GeoAtomFeed(object):
    ...
    def add(self, *args, **kwargs):
        ...
        """
        if len(args) == 1 and not kwargs and isinstance(args[0], GeoFeedEntry):
            self.entries.append(args[0])
        else:
            kwargs['feed_url'] = self.feed_url
            self.entries.append(GeoFeedEntry(*args, **kwargs))
    ...
    def generate(self):
        ...
        yield u'<feed xmlns="http://www.w3.org/2005/Atom" xmlns:georss="http://www.georss.org/georss">\n'
...
class GeoFeedEntry(object):
    ...
    :param lat_lon: The latitude and longitude for the entry
    ...
    def __init__(self, title=None, content=None, feed_url=None, **kwargs):
        ...
        self.lat_lon = kwargs.get('lat_lon', None)
